...
module GptMigrate
  module Utils
    ...
    INSTRUCTIONS_PREFIX = 'INSTRUCTIONS:'.freeze
    ...
    def parse_code_string(code_string)
      ...
      sections.each do |section|
        ...
        if match
          _, language, code = match.captures
    ...
    def construct_globals
      ...
      source_language = files_prompt(source_directory_structure,
                                     'What is the main programming language of this project?')
