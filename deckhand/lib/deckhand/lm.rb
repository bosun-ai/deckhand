module Deckhand
  module Lm
    ...
    DEFAULT_SYSTEM = 'You are a helpful assistant that provides information without formalities.'.freeze
    ...
    def self.prompt(prompt_text, functions: nil, system: DEFAULT_SYSTEM, max_tokens: 2049, mode: :default)
      DeckhandTracer.in_span('PROMPT') do
        ...
        current_span.add_event('prompt',
                               attributes: { prompt: prompt_text, system:, max_tokens:,
                                             mode: mode.to_s }.stringify_keys)
