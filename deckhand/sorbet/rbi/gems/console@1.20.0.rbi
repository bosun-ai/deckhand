...
# source://console//lib/console/output/encoder.rb#8
class Console::Output::Encoder
  # @return [Encoder] a new instance of Encoder
  #
  # source://console//lib/console/output/encoder.rb#9
  def initialize(output, encoding = T.unsafe(nil)); end

  # source://console//lib/console/output/encoder.rb#18
  def call(subject = T.unsafe(nil), *arguments, **options, &block); end

  # source://console//lib/console/output/encoder.rb#26
  def encode(value); end

  # Returns the value of attribute encoding.
  #
  # source://console//lib/console/output/encoder.rb#16
  def encoding; end

  # Returns the value of attribute output.
  #
  # source://console//lib/console/output/encoder.rb#14
  def output; end
end
...
module Console::Output::JSON
  class << self
    # source://console//lib/console/output/json.rb#12
    def new(output, **options); end
  end
end
