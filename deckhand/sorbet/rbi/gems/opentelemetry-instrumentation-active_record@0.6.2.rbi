...
class OpenTelemetry::Instrumentation::ActiveRecord::Instrumentation < ::OpenTelemetry::Instrumentation::Base
  ...
  # source://opentelemetry-instrumentation-active_record//lib/opentelemetry/instrumentation/active_record/instrumentation.rb#34
  def gem_version; end

  # source://opentelemetry-instrumentation-active_record//lib/opentelemetry/instrumentation/active_record/instrumentation.rb#38
  def patch; end

  # source://opentelemetry-instrumentation-active_record//lib/opentelemetry/instrumentation/active_record/instrumentation.rb#58
  def require_dependencies; end
end

# source://opentelemetry-instrumentation-active_record//lib/opentelemetry/instrumentation/active_record/instrumentation.rb#13
OpenTelemetry::Instrumentation::ActiveRecord::Instrumentation::MAX_MAJOR_VERSION = T.let(T.unsafe(nil), Integer)
