...
class IO::Event::Selector::Select
  ...
  # source://io-event//lib/io/event/selector/select.rb#191
  ...
  # source://io-event//lib/io/event/selector/select.rb#300
  ...
  # source://io-event//lib/io/event/selector/select.rb#319
  def select(duration = T.unsafe(nil)); end
