...
class Rufo::Formatter
  ...
  # source://rufo//lib/rufo/formatter.rb#4169
  ...
  # source://rufo//lib/rufo/formatter.rb#1431
  def consume_block_args(args); end

  # source://rufo//lib/rufo/formatter.rb#1048
  def consume_call_dot; end

  # source://rufo//lib/rufo/formatter.rb#3681
  def consume_embedded_comment; end

  # source://rufo//lib/rufo/formatter.rb#3694
  def consume_end; end
  ...
  #
  # source://rufo//lib/rufo/formatter.rb#3508
  ...
  # source://rufo//lib/rufo/formatter.rb#3485
  def consume_keyword(value); end

  # source://rufo//lib/rufo/formatter.rb#3494
  def consume_op(value); end

  # source://rufo//lib/rufo/formatter.rb#1957
  def consume_op_or_keyword; end

  # source://rufo//lib/rufo/formatter.rb#3709
  def consume_pin_op; end

  # source://rufo//lib/rufo/formatter.rb#3358
  def consume_space(want_preserve_whitespace: T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#1260
  def consume_space_after_command_name; end

  # source://rufo//lib/rufo/formatter.rb#3369
  def consume_space_or_newline; end

  # source://rufo//lib/rufo/formatter.rb#3466
  def consume_token(kind); end

  # source://rufo//lib/rufo/formatter.rb#3472
  ...
  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#575
  def declaration?(exp); end

  # source://rufo//lib/rufo/formatter.rb#4059
  def dedent_calls; end

  # source://rufo//lib/rufo/formatter.rb#4120
  def do_align(components, scope); end

  # source://rufo//lib/rufo/formatter.rb#4116
  def do_align_case_when; end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3460
  def empty_body?(body); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#2132
  def empty_params?(node); end

  # source://rufo//lib/rufo/formatter.rb#3973
  ...
  # source://rufo//lib/rufo/formatter.rb#2125
  def format_endless_method; end

  # source://rufo//lib/rufo/formatter.rb#650
  def format_simple_string(node); end

  # source://rufo//lib/rufo/formatter.rb#3716
  def indent(value = T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#3869
  ...
  # source://rufo//lib/rufo/formatter.rb#3729
  def indent_body(exps, force_multiline: T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#4093
  def indent_literals; end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#908
  def indentable_value?(value); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3941
  def keyword?(keyword); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#4018
  def last?(index, array); end

  # source://rufo//lib/rufo/formatter.rb#3806
  ...
  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#4200
  def need_space_for_hash?(node, elements, closing_brace_token); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#556
  def needs_two_lines?(exp); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3945
  def newline?; end

  # source://rufo//lib/rufo/formatter.rb#3904
  def next_indent; end

  # source://rufo//lib/rufo/formatter.rb#3991
  def next_token; end

  # source://rufo//lib/rufo/formatter.rb#4014
  def next_token_no_heredoc_check; end

  # source://rufo//lib/rufo/formatter.rb#4209
  def node_line(node, beginning: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3965
  def op?(value); end

  # source://rufo//lib/rufo/formatter.rb#4022
  def push_call(node); end

  # source://rufo//lib/rufo/formatter.rb#4041
  def push_hash(node); end

  # source://rufo//lib/rufo/formatter.rb#4032
  def push_node(node); end

  # source://rufo//lib/rufo/formatter.rb#4048
  def push_type(node); end

  # Which quote character are we using?
  #
  # source://rufo//lib/rufo/formatter.rb#633
  def quote_char; end

  # source://rufo//lib/rufo/formatter.rb#4181
  def remove_lines_before_inline_declarations; end

  # source://rufo//lib/rufo/formatter.rb#4195
  def result; end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3953
  def semicolon?; end
  ...
  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#638
  ...
  #
  # source://rufo//lib/rufo/formatter.rb#622
  def simple_string(node); end

  # source://rufo//lib/rufo/formatter.rb#3385
  def skip_ignored_space; end

  # source://rufo//lib/rufo/formatter.rb#3454
  def skip_semicolons; end

  # source://rufo//lib/rufo/formatter.rb#3379
  def skip_space; end

  # source://rufo//lib/rufo/formatter.rb#3397
  def skip_space_backslash; end

  # source://rufo//lib/rufo/formatter.rb#3389
  def skip_space_no_heredoc_check; end

  # source://rufo//lib/rufo/formatter.rb#3409
  def skip_space_or_newline(_want_semicolon: T.unsafe(nil), write_first_semicolon: T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#3845
  def skip_space_or_newline_using_setting(setting, indent_size = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3961
  def space?; end

  # source://rufo//lib/rufo/formatter.rb#4055
  def to_ary(node); end

  # source://rufo//lib/rufo/formatter.rb#951
  def track_alignment(key, target, offset = T.unsafe(nil), id = T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#943
  def track_assignment(offset = T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#947
  def track_case_when; end

  # source://rufo//lib/rufo/formatter.rb#934
  def track_comment(id: T.unsafe(nil), match_previous_id: T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#190
  def visit(node); end

  # source://rufo//lib/rufo/formatter.rb#2742
  def visit_alias(node); end

  # source://rufo//lib/rufo/formatter.rb#1522
  def visit_args_add_star(node); end

  # source://rufo//lib/rufo/formatter.rb#2260
  def visit_array(node); end

  # source://rufo//lib/rufo/formatter.rb#2481
  def visit_array_access(node); end

  # source://rufo//lib/rufo/formatter.rb#2500
  def visit_array_getter_or_setter(name, args); end

  # source://rufo//lib/rufo/formatter.rb#3132
  def visit_array_pattern(node); end

  # source://rufo//lib/rufo/formatter.rb#2490
  def visit_array_setter(node); end

  # source://rufo//lib/rufo/formatter.rb#818
  def visit_assign(node); end

  # source://rufo//lib/rufo/formatter.rb#884
  def visit_assign_value(value); end

  # source://rufo//lib/rufo/formatter.rb#1558
  def visit_begin(node); end

  # source://rufo//lib/rufo/formatter.rb#1756
  def visit_begin_node(node); end

  # source://rufo//lib/rufo/formatter.rb#1764
  def visit_begin_or_end(node, keyword); end

  # source://rufo//lib/rufo/formatter.rb#1907
  def visit_binary(node); end

  # source://rufo//lib/rufo/formatter.rb#1442
  def visit_block_arguments(node); end

  # source://rufo//lib/rufo/formatter.rb#1581
  def visit_bodystmt(node); end

  # source://rufo//lib/rufo/formatter.rb#1360
  def visit_brace_block(node); end

  # source://rufo//lib/rufo/formatter.rb#2598
  def visit_break(node); end

  # source://rufo//lib/rufo/formatter.rb#1490
  def visit_call_args(node); end

  # source://rufo//lib/rufo/formatter.rb#1085
  def visit_call_at_paren(node, args); end

  # source://rufo//lib/rufo/formatter.rb#1343
  def visit_call_with_block(node); end

  # source://rufo//lib/rufo/formatter.rb#1000
  def visit_call_with_receiver(node); end

  # source://rufo//lib/rufo/formatter.rb#1056
  def visit_call_without_receiver(node); end

  # source://rufo//lib/rufo/formatter.rb#2972
  def visit_case(node); end

  # source://rufo//lib/rufo/formatter.rb#1967
  def visit_class(node); end

  # source://rufo//lib/rufo/formatter.rb#1789
  ...
  # source://rufo//lib/rufo/formatter.rb#1670
  def visit_mlhs(node); end

  # source://rufo//lib/rufo/formatter.rb#1821
  def visit_mlhs_add_star(node); end

  # source://rufo//lib/rufo/formatter.rb#1677
  def visit_mlhs_or_mlhs_paren(args); end

  # source://rufo//lib/rufo/formatter.rb#1661
  def visit_mlhs_paren(node); end

  # source://rufo//lib/rufo/formatter.rb#1994
  def visit_module(node); end

  # source://rufo//lib/rufo/formatter.rb#1710
  def visit_mrhs_add_star(node); end

  # source://rufo//lib/rufo/formatter.rb#1647
  def visit_mrhs_new_from_args(node); end

  # source://rufo//lib/rufo/formatter.rb#863
  def visit_multiple_assign(node); end

  # source://rufo//lib/rufo/formatter.rb#2603
  def visit_next(node); end

  # source://rufo//lib/rufo/formatter.rb#836
  def visit_op_assign(node); end

  # source://rufo//lib/rufo/formatter.rb#2156
  def visit_params(node); end

  # source://rufo//lib/rufo/formatter.rb#2137
  def visit_paren(node); end

  # source://rufo//lib/rufo/formatter.rb#802
  def visit_path(node); end

  # source://rufo//lib/rufo/formatter.rb#2289
  def visit_q_or_i_array(node); end

  # source://rufo//lib/rufo/formatter.rb#784
  def visit_quoted_symbol_literal(node); end

  # source://rufo//lib/rufo/formatter.rb#2455
  def visit_range(node, inclusive); end

  # source://rufo//lib/rufo/formatter.rb#2466
  def visit_regexp_literal(node); end

  # source://rufo//lib/rufo/formatter.rb#1643
  def visit_rescue_types(node); end

  # source://rufo//lib/rufo/formatter.rb#1850
  def visit_rest_param(node); end

  # source://rufo//lib/rufo/formatter.rb#2593
  def visit_return(node); end

  # source://rufo//lib/rufo/formatter.rb#2545
  def visit_sclass(node); end

  # source://rufo//lib/rufo/formatter.rb#2563
  def visit_setter(node); end

  # source://rufo//lib/rufo/formatter.rb#2442
  def visit_splat_inside_hash(node); end

  # source://rufo//lib/rufo/formatter.rb#714
  def visit_string_concat(node); end

  # source://rufo//lib/rufo/formatter.rb#759
  def visit_string_dvar(node); end

  # source://rufo//lib/rufo/formatter.rb#747
  def visit_string_interpolation(node); end

  # source://rufo//lib/rufo/formatter.rb#584
  def visit_string_literal(node); end

  # source://rufo//lib/rufo/formatter.rb#685
  def visit_string_literal_end(node); end

  # source://rufo//lib/rufo/formatter.rb#981
  def visit_suffix(node, suffix); end

  # source://rufo//lib/rufo/formatter.rb#2695
  def visit_super(node); end

  # source://rufo//lib/rufo/formatter.rb#776
  def visit_symbol(node); end

  # source://rufo//lib/rufo/formatter.rb#765
  def visit_symbol_literal(node); end

  # source://rufo//lib/rufo/formatter.rb#964
  def visit_ternary_if(node); end

  # source://rufo//lib/rufo/formatter.rb#1874
  def visit_unary(node); end

  # source://rufo//lib/rufo/formatter.rb#2753
  def visit_undef(node); end

  # source://rufo//lib/rufo/formatter.rb#2904
  def visit_unless(node); end

  # source://rufo//lib/rufo/formatter.rb#2951
  def visit_until(node); end

  # source://rufo//lib/rufo/formatter.rb#3001
  def visit_when(node); end

  # source://rufo//lib/rufo/formatter.rb#2946
  def visit_while(node); end

  # source://rufo//lib/rufo/formatter.rb#2956
  def visit_while_or_until(node, keyword); end

  # source://rufo//lib/rufo/formatter.rb#2608
  def visit_yield(node); end

  # @return [Boolean]
  #
  # source://rufo//lib/rufo/formatter.rb#3969
  ...
  # multiple lines.
  #
  # source://rufo//lib/rufo/formatter.rb#677
  def with_unmodifiable_string_lines; end

  # source://rufo//lib/rufo/formatter.rb#3825
  def write(value); end

  # source://rufo//lib/rufo/formatter.rb#3864
  def write_indent(indent = T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#3857
  def write_line; end

  # source://rufo//lib/rufo/formatter.rb#2252
  def write_params_comma; end

  # source://rufo//lib/rufo/formatter.rb#3832
  def write_space(value = T.unsafe(nil)); end

  # source://rufo//lib/rufo/formatter.rb#3837
