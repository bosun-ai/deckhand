...
module GeneratedUrlHelpersModule
  ...
  def agent_run_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def agent_runs_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def callback_github_app_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def codebase_discover_testing_infrastructure_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def codebase_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def codebases_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_agent_run_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_codebase_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_rails_conductor_inbound_email_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_shell_task_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def event_github_app_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def main_deck_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_agent_run_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_codebase_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def new_shell_task_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def setup_github_app_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def shell_task_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def shell_tasks_url(*args); end
