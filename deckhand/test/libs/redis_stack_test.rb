...
#     results = RedisStack.graph_match 'MotoGP',
#                                      "(r:Rider)-[:rides]->(t:Team) WHERE t.name = 'Yamaha' RETURN r.name, t.name"
